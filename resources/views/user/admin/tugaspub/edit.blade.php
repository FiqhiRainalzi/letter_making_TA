                        ...
                        <form action="{{ route('admin.tugaspubUpdate', $tugaspub->id) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nomorSurat') is-invalid @enderror"
                                    name="nomorSurat" value="{{ old('nomorSurat', $tugaspub->nomorSurat) }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="statusSurat" id="statusSurat" class="form-control">
                                    <option value="pending" {{ $tugaspub->statusSurat == 'pending' ? 'selected' : '' }}>Pending</option>
                                    <option value="approved" {{ $tugaspub->statusSurat == 'approved' ? 'selected' : '' }}>Approved
                                    </option>
                                    <option value="rejected" {{ $tugaspub->statusSurat == 'rejected' ? 'selected' : '' }}>Rejected
                                    </option>
                                </select>
                            </div>
