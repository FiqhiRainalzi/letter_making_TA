...
@section('content')
    <div class="pagetitle">
        <h1>Surat Tugas Publikasi Nasional</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Surat Tugas Publikasi Nasional</li>
                <li class="breadcrumb-item active">Preview Surat Tugas Publikasi Nasional</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <body>
        ...
        <a href="{{ route('admin.tugaspubDownload', $tugaspub->id) }}"class="btn btn-sm btn-primary">Download <i
