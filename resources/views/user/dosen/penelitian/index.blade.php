    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('penelitian.create') }}" class="btn btn-sm btn-success"><i class="bi bi-plus-circle"></i> Buat Surat
                            Tugas Penelitian</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form id="deleteForm-{{ $p->id }}"
                                                action="{{ route('penelitian.destroy', $p->id) }}" method="POST">
                                                <a href="{{ route('penelitian.show', $p->id) }}"
